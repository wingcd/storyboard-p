...
class UIScene extends ViewScene {
    ...
    create(): void {
        ...
        // list.itemRenderer = (idx, item)=>{
        //     (item as UIButton).title = `按钮${idx+1}`
        // };
        // list.itemNum = 20;
        // list.virtual = true;
        ...
        for(let i =0 ;i<3;i++) {
            let item = list.addItem() as Button;
        ...
        let newList = Package.inst.createObjectFromUrl(this, listRes) as List;
        newList.x = 220;
