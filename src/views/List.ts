...
import { EHorAlignType, EListLayoutType, EOverflowType, EScrollType, EVertAlignType } from "../core/Defines";
import { ViewGroup } from "../core/ViewGroup";
import { View } from "../core/View";
import { IList } from "../types/views/IList";
...
const enum EVirtualListChangedType {
    None = 0,
    ContentChanged = 1,
    SizeChanged = 2
};
 ...
 * 目前不支持虚拟列表和多行列时的循环
 */
export class List extends ViewGroup  implements IList{
    static TYPE = "list";
    ...
    {      
        let fields = List.SERIALIZABLE_FIELDS;  
