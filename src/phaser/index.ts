...
export import Geom = Phaser.Geom;
export import Point = Phaser.Geom.Point;
export import Line = Phaser.Geom.Line;
export import Triangle = Phaser.Geom.Triangle;
export import Rectangle = Phaser.Geom.Rectangle;
export import Circle = Phaser.Geom.Circle;
export import Ellipse = Phaser.Geom.Ellipse;
export import Polygon = Phaser.Geom.Polygon;
